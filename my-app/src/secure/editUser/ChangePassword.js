        ...
        return (<Card>
            ...
            <CardBody>
                ...
                <AvForm onSubmit={this.updatePassword} >
                    <AvField name="old" type="text" label="Old Password" errorMessage="Enter Correct Password" placeholder="Enter Old Password" value={color === "danger" && ""} required />
                    <AvField name="new" type="text" label="New Password" errorMessage="New Password Required" placeholder="Enter  New Password" required />
                    <center>

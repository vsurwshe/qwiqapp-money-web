...
class UpdateBillForm extends Component {
    ...
    render() {
        const { currencies, userAmount, taxPercent, bill, categories, labels, contacts, billType } = this.props.updateForm;
        ...
        return (
            <AvForm onSubmit={this.props.handleSubmitValue}>
                ...
                <Row>
                    ...
                    <Col>
                        <AvField name='dummy' label="Tax Amount" value={bill.taxAmount_<0 ? - (bill.taxAmount_) : bill.taxAmount_} placeholder="0" type="number"
                ...
                <Row>
                    ...
                    <Col>
                    <AvField name="dueDate" label="Due Date" value={this.state.dueDate} type="date" errorMessage="Invalid Date" 
                        validate={{
                            date: { format: 'yyyy/MM/dd' }, dateRange: { format: 'YYYY/MM/DD', start: { value: '1900/01/01' }, end: { value: '9999/12/31' } },
                            required: { value: true }
                        }} />
              ...
              {checked && 
                <Row>
                  ...
                  <Col><AvField name="notifyDate" label="notify Date" value={this.state.notifyDate} type="date" errorMessage="Invalid Date" 
                         validate={{
                            date: { format: 'yyyy/MM/dd' }, dateRange: { format: 'YYYY/MM/DD', start: { value: '1900/01/01' }, end: { value: '9999/12/31' } },
                            required: { value: true } }}
                  /></Col>

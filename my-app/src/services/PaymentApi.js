...
class PaymentApi extends AbstractApi {
  ...
  addBillPayment(success, failure, profileId, billId, data) {
    this.process(success, failure, profileId + "/bills/" + billId + "/payments", this.apiMethod.POST, profileId, data, null, billId);
  }

  //This Method Get All Bills
  getBillPayments(success, failure, profileId, billId) {
    this.process(success, failure, profileId + "/bills/" + billId + "/payments", this.apiMethod.GET, profileId, null, null, billId);
  }

  //This Method Update Bill 
  updateBillPayment(success, failure, profileId, billId, billPaymentId, data) {
    this.process(success, failure, profileId + "/bills/" + billId + "/payments/" + billPaymentId, this.apiMethod.PUT, profileId, data, null, billId);
  }

  //This Method Delete Bill
  deleteBillPayment(success, failure, profileId, billId, billPaymentId) {
    this.process(success, failure, profileId + "/bills/" + billId + "/payments/" + billPaymentId, this.apiMethod.DELETE, profileId, null, null, billId);
  }
